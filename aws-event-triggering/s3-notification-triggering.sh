...
bucket_name="amish-ultimate-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="domadiyaamish@gmail.com"
...
#Extract the role ARN form the JSON esponse and store ot in a variable
...
aws sns publish \
  ...
  --message "Hello from Domadiya Amish govindbhai"
